...
parser.add_argument('--build-dir', help='Directory to build in.',
                    type=str, action='store', required=False, default='int.p4app')
...
parser.add_argument('--manifest', help='Path to manifest file.',
                    type=str, action='store', required=False, default='int_v1.0.json')
...
def run_custom(manifest):
    output_file = run_compile_bmv2(manifest)
    python_path = 'PYTHONPATH=$PYTHONPATH:../docker/scripts/mininet/'
    script_args = []
